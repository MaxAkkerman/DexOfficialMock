...
function RevealSeedPhrase() {
  ...
  const seedPhrase = useAppSelector(
    (state) => state.enterSeedPhrase.revealSeedPhraseText,
  );
                ...
                <Grid container spacing={3} sx={{ justifyContent: "center" }}>
                  <Grid item>
                    <Autocomplete
                      ...
                      sx={{ width: 160 }}
                      renderInput={(params) => (
                        <CssTextField {...params} label="Word 1" />
                      )}
                    />
                  </Grid>
                  <Grid item>
                    <Autocomplete
                      ...
                      sx={{ width: 160 }}
                      renderInput={(params) => (
                        <CssTextField {...params} label="Word 2" />
                      )}
                    />
                  </Grid>
                  <Grid item>
                    <Autocomplete
                      ...
                      sx={{ width: 160 }}
                      renderInput={(params) => (
                        <CssTextField {...params} label="Word 3" />
                      )}
                    />
                  </Grid>
                  <Grid item>
                    <Autocomplete
                      ...
                      sx={{ width: 160 }}
                      renderInput={(params) => (
                        <CssTextField {...params} label="Word 4" />
                      )}
                    />
                  </Grid>
                  <Grid item>
                    <Autocomplete
                      ...
                      sx={{ width: 160 }}
                      renderInput={(params) => (
                        <CssTextField {...params} label="Word 5" />
                      )}
                    />
                  </Grid>
                  <Grid item>
                    <Autocomplete
                      ...
                      sx={{ width: 160 }}
                      renderInput={(params) => (
                        <CssTextField {...params} label="Word 6" />
                      )}
                    />
                  </Grid>
                  <Grid item>
                    <Autocomplete
                      ...
                      sx={{ width: 160 }}
                      renderInput={(params) => (
                        <CssTextField {...params} label="Word 7" />
                      )}
                    />
                  </Grid>
                  <Grid item>
                    <Autocomplete
                      ...
                      sx={{ width: 160 }}
                      renderInput={(params) => (
                        <CssTextField {...params} label="Word 8" />
                      )}
                    />
                  </Grid>
                  <Grid item>
                    <Autocomplete
                      ...
                      sx={{ width: 160 }}
                      renderInput={(params) => (
                        <CssTextField {...params} label="Word 9" />
                      )}
                    />
                  </Grid>
                  <Grid item>
                    <Autocomplete
                      ...
                      sx={{ width: 160 }}
                      renderInput={(params) => (
                        <CssTextField {...params} label="Word 10" />
                      )}
                    />
                  </Grid>
                  <Grid item>
                    <Autocomplete
                      ...
                      sx={{ width: 160 }}
                      renderInput={(params) => (
                        <CssTextField {...params} label="Word 11" />
                      )}
                    />
                  </Grid>
                  <Grid item>
                    <Autocomplete
                      ...
                      sx={{ width: 160 }}
                      renderInput={(params) => (
                        <CssTextField {...params} label="Word 12" />
                      )}
                    />
                  </Grid>
                </Grid>
