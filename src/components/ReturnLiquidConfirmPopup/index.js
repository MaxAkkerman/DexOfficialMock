...
// TODO: Delete later. It's just a muck function
...
function ReturnLiquidConfirmPopup(props) {
  ...
  async function handleRemoveConfirm() {
    ...
    let returnStatus = await returnLiquidity(
      curExt,
      pairId,
            ...
            >
              <div className="returnViewDataItem">
                ...
                <div className="displayFlex">
                  <img
                    ...
                    src={iconGenerator(props.fromToken.symbol)}
                    alt={props.fromToken.symbol}
                  />
              ...
              <div className="returnViewDataItem">
                ...
                <div className="displayFlex">
                  <img
                    className="confirm-icon"
                    src={iconGenerator(props.toToken.symbol)}
                    alt={props.toToken.symbol}
                  />
                  <span className="confirm-tokenF" style={{ fontSize: "22px" }}>
